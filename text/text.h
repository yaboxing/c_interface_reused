...
extern char* Text_get(const* str, int size, T s);
...
extern int   Text_fmt(int code, va_list* app, int put(int c, void* cl), void* cl, unsigned char flags[], int width, int precision);
