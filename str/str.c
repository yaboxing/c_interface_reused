...
int Str_math(const char* s, int i, int j, const char* str)
{
	int len;
	convert(s, i, j);
	assert(str);
...
int Str_rmath(const char* s, int i, int j, const char* str)
{
	int len;
	convert(s, i, j);
	assert(str);
...
int Str_fmt(int code, va_list* app, int put(int c, void* cl), void* cl, unsigned char flags[], int width, int precision)
{
	char* s;
	int i;
	int j;
